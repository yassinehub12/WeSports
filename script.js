document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ...
        ar: {
            ...
            live_football_match: "مباراة كرة قدم مباشرة",
            hd_quality: "جودة عالية",
            sports_channels: "القنوات الرياضية",
            loading_channels: "جاري تحميل القنوات...",
            need_help: "هل تحتاج مساعدة في البث؟",
            ...
            mins: "دقائق",
            secs: "ثواني",
            time_until_match: "الوقت حتى المباراة:"
        }
    };
    ...
    const sportsChannels = [
        {
            name: { en: "Dubai Sports 1", ar: "دبي الرياضية 1" },
        ...
        {
            name: { en: "Dubai Sports 2", ar: "دبي الرياضية 2" },
        ...
        {
            name: { en: "Dubai Sports 3", ar: "دبي الرياضية 3" },
        ...
        {
            name: { en: "Sharjah Sports", ar: "الشارقة الرياضية" },
        ...
        {
            name: { en: "Bahrain Sports 1", ar: "البحرين الرياضية 1" },
        ...
        {
            name: { en: "Bahrain Sports 2", ar: "البحرين الرياضية 2" },
    ...
    function setLanguage(lang) {
        ...
        if (lang === 'ar') {
            ...
            document.title = "WeSports - بث مباشر مباريات كرة القدم | مشاهدة مباريات اليوم مجاناً";
        } else {
    ...
    function fetchMatches() {
        ...
        .then(allMatches => {
            ...
            if (filteredMatches.length > 0) {
                ...
                matchesContainer.innerHTML = `<div class="loading-matches">${currentLanguage === 'ar' ? 'لا توجد مباريات كبيرة في الـ 20 يومًا القادمة.' : 'No big matches in the next 20 days.'}</div>`;
            }
        })
        .catch(error => {
            matchesContainer.innerHTML = `<div class="loading-matches">${currentLanguage === 'ar' ? 'خطأ في تحميل المباريات.' : 'Error loading matches.'}</div>`;
        });
    }
